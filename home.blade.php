    ...
    <div class="container flex flex-col space-y-5 lg:space-y-0 lg:space-x-5 lg:flex-row">
      <div class="flex items-center justify-center flex-1 px-3 py-6 space-x-6 border-2 border-white ">
        ...
        <div class="space-y-1 text-white">
          <h3 class="text-base font-bold">High Quality</h3>
      ...
      <div class="flex items-center justify-center flex-1 px-3 py-6 space-x-6 border-2 border-white ">
        ...
        <div class="space-y-1 text-white">
          <h3 class="text-base font-bold">Warranty Protection</h3>
      ...
      <div class="flex items-center justify-center flex-1 px-3 py-6 space-x-6 border-2 border-white ">
        ...
        <div class="space-y-1 text-white">
          <h3 class="text-base font-bold">Free Shipping</h3>
      ...
      <div class="flex items-center justify-center flex-1 px-3 py-6 space-x-6 border-2 border-white ">
        ...
        <div class="space-y-1 text-white">
          <h3 class="text-base font-bold">24 / 7 Support</h3>
